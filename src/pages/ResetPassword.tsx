    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md bg-white/95 backdrop-blur-md p-8 sm:p-10 rounded-2xl shadow-2xl border border-white/20 lg:mr-8 xl:mr-16">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900">Redefinir Senha</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 mt-8">
          ...
          <div className="space-y-2">
            <Label htmlFor="passwordConfirm" className="text-slate-700 font-medium">
            ...
            <Input
              ...
              placeholder="••••••••"
              autoComplete="new-password"
              className={`h-11 bg-white ${errors.passwordConfirm ? 'border-red-500' : 'border-slate-200'}`}
