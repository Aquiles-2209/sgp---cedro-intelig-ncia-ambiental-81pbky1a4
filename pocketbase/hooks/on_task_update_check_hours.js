// Notifica o gerente do projeto (ou admins/masters) quando, ao atualizar
// allocated_hours de uma tarefa, o total de horas trabalhadas passa a exceder
// as horas previstas (planned_hours).
//
...
//
// Só dispara quando allocated_hours realmente muda. A notificação é criada uma
// única vez por tarefa por dia (deduplicação por título + conteúdo mencionando
// a tarefa, no mesmo dia calendário).
